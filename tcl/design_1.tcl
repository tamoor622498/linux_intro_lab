...
\
  ...
  connect_bd_intf_net -intf_net RGBLEDS_GPIO [get_bd_intf_ports LED0] [get_bd_intf_pins RGBLEDS/GPIO]
  connect_bd_intf_net -intf_net RGBLEDS_GPIO2 [get_bd_intf_ports LED1] [get_bd_intf_pins RGBLEDS/GPIO2]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins RGBLEDS/S_AXI]
  ...
  [get_bd_pins RGBLEDS/s_axi_aclk] \
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -with_name SEG_axi_gpio_0_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RGBLEDS/S_AXI/Reg] -force
